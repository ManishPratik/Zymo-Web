...
const CompareAndChoice = () => {
    return (
        <>
            ...
            <div className="bg-darkGrey2 rounded-lg px-4 sm:px-6 md:px-8 py-8 mx-auto max-w-[95%] sm:max-w-3xl md:max-w-4xl overflow-hidden">
                ...
                <div className="relative grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 gap-12 text-[#faffa4] text-center">
                    <div>
                        ...
                        <h3 className="text-base md:text-lg font-semibold">Compare and Choose</h3>
                    </div>

                    <div>
                        <FaCar className="text-4xl md:text-3xl mx-auto mb-3" />
                        <h3 className="text-base md:text-lg font-semibold">Flexible Options</h3>
                    </div>

                    <div>
                        <FaWallet className="text-4xl md:text-3xl mx-auto mb-3" />
                        <h3 className="text-base md:text-lg font-semibold">Easy to Use</h3>
                    </div>
                </div>
            </div>
        </>
